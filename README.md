...
Одним из важных принципов создания утилит в Linux является т.н. UNIX-way (подход UNIX): одна утилита должна осущствлять одно действие, но делать это хорошо.
