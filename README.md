...
Принцип работы git основывается на использовании утилиты diff, которая определяет разницу между 2 или большим числом файлов на основе переносов строк (символов `\n`).
